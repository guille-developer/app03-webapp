...
class EditCulture extends Component {
  state = {};
    ...
    return (
      <div className="rounded container border-gray border-2 mt-12 m-auto bg-gray-100 w-10/12 h-12/12">
        <form className="bg-white m-2 p-2">
          ...
          <div className="flex justify-between m-2">
            {" "}
            <h1 className="ml-right">Start Date: </h1>
            <input type="date" name="startDate" id="startDate" />
          </div>
          <div className="flex justify-between m-2">
            {" "}
            <h1 className="ml-right">Start Time: </h1>
          ...
          <div>
            ...
            <div className="text-center ">
              <button
                type="submit"
                className="rounded p-2 mb-10  text-white bg-gradient-to-r from-green-400  to-green-800"
              >
                End Culture
              </button>
            </div>
            <div className="text-center ">
              <button
                type="submit"
                className="rounded p-2  text-white bg-gradient-to-r from-green-400  to-green-800"
              >
                Cancel
              </button>
            </div>
